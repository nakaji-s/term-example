...
},{"./utils/CircularList":20}],2:[function(require,module,exports){
"use strict";
...
var InputHandler = (function () {
    ...
    InputHandler.prototype.insertChars = function (params) {
        ...
        var ch = [this._terminal.eraseAttr(), ' ', 1];
    ...
    InputHandler.prototype.repeatPrecedingCharacter = function (params) {
        ...
        var ch = line[this._terminal.buffer.x - 1] || [this._terminal.defAttr, ' ', 1];
        while (param--) {
    ...
    Renderer.prototype._refresh = function (start, end) {
        ...
        for (; y <= end; y++) {
            ...
            for (var i = 0; i < width; i++) {
                var data = line[i][0];
                var ch = line[i][Buffer_1.CHAR_DATA_CHAR_INDEX];
                var ch_width = line[i][Buffer_1.CHAR_DATA_WIDTH_INDEX];
                var isCursor = i === x;
                if (!ch_width) {
                    continue;
                }
...
function checkBoldBroken(terminalElement) {
    var document = terminalElement.ownerDocument;
...
},{"./Buffer":1,"./utils/DomElementObjectPool":21}],11:[function(require,module,exports){
"use strict";
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
    ...
    SelectionManager.prototype._getWordAt = function (coords) {
        ...
        if (line.charAt(startIndex) === ' ') {
            ...
            while (startIndex > 0 && !this._isCharWordSeparator(line.charAt(startIndex - 1))) {
                if (bufferLine[startCol - 1][Buffer_1.CHAR_DATA_WIDTH_INDEX] === 0) {
                    leftWideCharCount++;
                    startCol--;
                }
                startIndex--;
            ...
            while (endIndex + 1 < line.length && !this._isCharWordSeparator(line.charAt(endIndex + 1))) {
                if (bufferLine[endCol + 1][Buffer_1.CHAR_DATA_WIDTH_INDEX] === 2) {
                    rightWideCharCount++;
                    endCol++;
                }
                endIndex++;
...
},{"./Buffer":1,"./EventEmitter":6,"./SelectionModel":12,"./utils/Browser":18,"./utils/Mouse":23}],12:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
var Terminal = (function (_super) {
    ...
    Terminal.prototype.scroll = function (isWrapped) {
        var row;
        var bufferNeedsTrimming = this.buffer.lines.length === this.buffer.lines.maxLength;
...
},{"./BufferSet":2,"./CompositionHelper":4,"./EscapeSequences":5,"./EventEmitter":6,"./InputHandler":7,"./Linkifier":8,"./Parser":9,"./Renderer":10,"./SelectionManager":11,"./Viewport":14,"./handlers/Clipboard":17,"./utils/Browser":18,"./utils/CharMeasure":19,"./utils/Mouse":23,"./utils/Sounds":24}],14:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"../../Terminal":13,"./SearchHelper":15}],17:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"./Generic":22}],19:[function(require,module,exports){
"use strict";
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
...
},{"../EventEmitter.js":6}],20:[function(require,module,exports){
"use strict";
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
...
},{"../EventEmitter":6}],21:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
